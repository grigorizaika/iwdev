...
class UserManager(BaseUserManager):
    ...
    def create_user(self, email, name, surname, phone, password=None):
        ...
        print('--- user address owner BEFORE ---', djangoUser.address_owner)


        User.create_cognito_user(djangoUser, password)

        print('---1---')
        print('--- user address owner AFTER ---', djangoUser.address_owner)
    ...
    def create_superuser(self, email, name, surname, phone, password):
        ...
        sys.stderr.write('------------- in create_superuser -----------------')
        ...
        print('zdes', djangoUser.address_owner)
        ...
        print('TUUUUUUT', djangoUser.address_owner)
# djangoUser.address_owner.save() ???
        djangoUser.save()
        return djangoUser
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def create_address_owner(instance):
        print('Creating AddressOwner for user ', instance)
        print('---2---')
        ...
        instance.save()
        print('address owner: ', instance.address_owner)
...
# TODO: Disallow Django user creation if Cognito user creation fails
    ...
    def create_cognito_user(instance, password):
        ...
        print('Creating cognito user', username, password)
        try:
