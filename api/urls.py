from api.views import (accept_hours_worked, admin_create_cognito_user,
                        change_password, client_addresses, confirm_sign_up, 
                        confirm_reset_password, FileView, 
...
urlpatterns = [
    ...
    url(r'^register_user/?$', admin_create_cognito_user),
    url(r'^respond_to_new_password_challenge/?$', respond_to_new_password_required_challenge),
]
